...
internal class CharactersStoreImpl(
    ...
    init {
        scope.launch {
            ...
            this@CharactersStoreImpl.totalPages = totalPages
            this@CharactersStoreImpl.nextPage = lastPageFetched
    ...
    private suspend fun fetchCharacters(page: Int) {
        ...
        try {
            val response: CharactersResponse = httpClient.get("api/character") {
                url {

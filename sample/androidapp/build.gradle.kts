...
dependencies {
    ...
    implementation("androidx.compose.material3:material3-window-size-class:${Deps.Compose.MATERIAL_VERSION}")
    implementation("androidx.compose.material3:material3:${Deps.Compose.MATERIAL_VERSION}")
    implementation("androidx.compose.ui:ui-tooling-preview:$VERSION")
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.5.1")
    implementation("com.google.accompanist:accompanist-flowlayout:${Deps.Compose.ACCOMPANIST_VERSION}")
